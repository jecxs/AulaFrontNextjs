...
import { Module, UpdateModuleDto } from '@/types/course';
...
export default function EditModuleModal({ isOpen, onClose, module, onSuccess }: Props) {
    const { updateModule } = useCoursesAdmin();
    const [form, setForm] = useState<UpdateModuleDto>({ title: '', description: '' });
                ...
                <div className="relative bg-white rounded-lg shadow-xl max-w-lg w-full">
                    <div className="flex items-center justify-between p-4 border-b">
                        <div className="flex items-center space-x-3">
                            ...
                            <div>
                                <h3 className="text-lg font-medium">Editar Módulo</h3>
                                <p className="text-sm text-gray-500">Actualiza la información del módulo</p>
                            </div>
                        </div>
